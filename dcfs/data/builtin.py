...
# -------- COCO+misc -------- #
def register_all_unify(root="datasets"):

    METASPLITS = [
        ("unify_trainval_all", "coco/trainval2014", "misc210k_cocosplit/datasplit/all_trainvalno5k.json"),
        ("unify_trainval_base", "coco/trainval2014", "misc210k_cocosplit/datasplit/all_trainvalno5k.json"),
        ("misc_trainval_all", "coco/trainval2014", "misc210k_cocosplit/datasplit/misc_trainvalno5k.json"),
        ("misc_trainval_base", "coco/trainval2014", "misc210k_cocosplit/datasplit/misc_trainvalno5k.json"),
        ("unify_test_all", "coco/trainval2014", "misc210k_cocosplit/datasplit/all_5k.json"),
        ("unify_test_base", "coco/trainval2014", "misc210k_cocosplit/datasplit/all_5k.json"),
        ("unify_test_novel", "coco/trainval2014", "misc210k_cocosplit/datasplit/all_5k.json"),
        ("misc_test_all", "coco/trainval2014","misc210k_cocosplit/datasplit/misc_5k.json"),
        ("misc_test_base", "coco/trainval2014","misc210k_cocosplit/datasplit/misc_5k.json"),
        ("misc_test_novel", "coco/trainval2014","misc210k_cocosplit/datasplit/misc_5k.json"),
    ]
    for prefix in ["all","base", "novel"]:
        for shot in [1, 2, 3, 5, 10, 30]:
            for seed in range(200):
                name = "unify_trainval_{}_{}shot_seed{}".format(prefix, shot, seed)
...
def register_all_coco(root="datasets"):
    ...
    METASPLITS = [
        ...
        ("coco14_test_all", "coco/trainval2014", "cocosplit/datasplit/5k.json"),
        ("coco14_test_base", "coco/trainval2014", "cocosplit/datasplit/5k.json"),
        ("coco14_test_novel", "coco/trainval2014", "cocosplit/datasplit/5k.json"),
    ]
