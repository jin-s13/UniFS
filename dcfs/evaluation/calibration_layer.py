...
from dcfs.evaluation.archs import resnet101, resnet50
...
class PrototypicalCalibrationBlock:
    ...
    def build_model(self):
        ...
        if self.cfg.TEST.PCB_MODELTYPE == 'r101':
            imagenet_model = resnet101()
        elif self.cfg.TEST.PCB_MODELTYPE == 'r50':
    ...
    def execute_calibration(self, inputs, dts,alpha=None):
        ...
        for i in range(ileft, iright):
            ...
            dts[0]['instances'].scores[i] = dts[0]['instances'].scores[i] * alpha + tmp_cos * (1 - alpha)
        return dts
